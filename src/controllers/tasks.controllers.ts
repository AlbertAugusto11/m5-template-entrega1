...
export class TasksControllers {
    ...
    async read(req: Request, res: Response) {
        ...
        const response = await this.tasksservices.read(req.query.category as string | undefined)
    ...
    async getToId(req: Request, res: Response) {
        ...
        const response = await this.tasksservices.getToId(Number(req.params.id))
